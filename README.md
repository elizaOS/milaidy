...
| Linux | [`.AppImage`](https://github.com/milady-ai/milady/releases/latest) / [`.deb`](https://github.com/milady-ai/milady/releases/latest) / [APT repo](#debian--ubuntu-apt) | I use arch btw |
