...
The dashboard UI includes an `AutonomousPanel` component that provides real-time visibility into autonomous operations. See the [Dashboard guide](/guides/dashboard#autonomous-panel) for full details on the panel's layout, event color coding, and responsive sizing.
