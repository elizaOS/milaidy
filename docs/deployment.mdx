  ...
  <Tab title="milaidy-gateway">
    ...
    services:
      milaidy-gateway:
        ...
        volumes:
          - ${MILADY_CONFIG_DIR}:/home/node/.milaidy
          - ${MILADY_WORKSPACE_DIR}:/home/node/.milaidy/workspace
        ports:
...
|-------------|---------------|---------|
| `MILADY_CONFIG_DIR` | `/home/node/.milaidy` | Configuration files (`milaidy.json`), database, secrets |
| `MILADY_WORKSPACE_DIR` | `/home/node/.milaidy/workspace` | Agent workspace files, uploaded knowledge, generated content |

<Tip>
The setup script defaults `MILADY_CONFIG_DIR` to `$HOME/.milaidy` and `MILADY_WORKSPACE_DIR` to `$HOME/.milaidy/workspace` on the host machine.
</Tip>
...
| `MILADY_CONFIG_DIR` | `$HOME/.milaidy` | Host path for configuration storage |
| `MILADY_WORKSPACE_DIR` | `$HOME/.milaidy/workspace` | Host path for workspace storage |
