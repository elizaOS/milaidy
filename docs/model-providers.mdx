...
Milaidy supports multiple AI model providers out of the box. Set the corresponding environment variable in `~/.milaidy/.env` or via `milaidy configure`.
...
Change the default model in your config file (`~/.milaidy/milaidy.json`):
