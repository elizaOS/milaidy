...
function extractTrajectoryDiagnostics(detailJson) {
  const llmCalls = Array.isArray(detailJson?.llmCalls) ? detailJson.llmCalls : [];
...
async function getTrajectoryDiagnostics(apiBaseUrl, timeoutMs, previousLatestId) {
        ...
        await withTimeout(
          (async () => {
            ...
            if (trajectory.diagnostics) {
              ...
              objectSmallCallCount = trajectory.diagnostics.objectSmallCallCount;
            }
          })(),
          perRunTimeoutMs,
